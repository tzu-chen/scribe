...
import bookTagsRouter from './routes/bookTags.ts';
import flowchartTagsRouter from './routes/flowchartTags.ts';
...
app.use('/api/book-tags', bookTagsRouter);
app.use('/api/flowchart-tags', flowchartTagsRouter);
